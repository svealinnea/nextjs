  ...
  return (
    <div className="container mx-auto py-12">
      ...
      <p className="text-sm opacity-50">
        Hello, I am sorry to hear that you are frustrated, I understand. I would
        be happy to help you with this issue, would you like to hop on a call or
        video chat and we can walk through the process together? I am happy to
        schedule some time to work through this with you. Looking forward to
        your response, Svea
      </p>
    </div>
  );
